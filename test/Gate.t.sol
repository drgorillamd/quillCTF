 ...
 *          should be returned, according to the function selector passed:
 ...
 *          corresponding "function"/jumpdest. If the selector is 0, the result is 0, and the
 ...
 *          Current size is 23 bytes - can do better :/
 *      
...
contract GateTest is Test {
    ...
    function deployGuardian() internal returns(address _deployment) {
        ...
        bytes memory bytecode = hex"6017600c60003960176000f3" hex"3d35600e8160e01c0257336010565b325b3d5260203df3";
...
// codecopy(at offset 0, from 13 (constructor size) to 0x17 (whole code size))
push1 0x17
push1 0x0c
push1 0x00
codecopy
// return (at offset 0, size 23)
push1 0x17
push1 0x00
return
// ---------------------------------------
